...
// User 用户信息表
type User struct {
	Uid      int       `gorm:"column:uid;type:int(11) unsigned;primary_key;AUTO_INCREMENT" json:"uid"`
	...
	Mtime    time.Time `gorm:"column:mtime;NOT NULL" json:"mtime"`
}
...
type LoginHistory struct {
	...
	Uid      int       `gorm:"column:uid;type:int(11) unsigned;default:0;comment:用户UID;NOT NULL" json:"uid"`
	State    uint8     `gorm:"column:state;type:tinyint(4) unsigned;default:0;comment:登录状态，0登录，1登出;NOT NULL" json:"state"`
	Ctime    time.Time `gorm:"column:ctime;comment:登录时间;NOT NULL" json:"ctime"`
